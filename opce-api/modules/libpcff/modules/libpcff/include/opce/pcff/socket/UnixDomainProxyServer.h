...
#ifndef _UnixDomainProxyServer_h
#define _UnixDomainProxyServer_h
...
class UnixDomainProxyServer : public pcff::Server
{
public:
   static UnixDomainProxyServer &instance();
