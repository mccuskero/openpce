...
#ifndef _IPv6SocketAddress_h
#define _IPv6SocketAddress_h
...
class IPv6SocketAddress : public SocketAddress
{
 public:
  IPv6SocketAddress();
  virtual ~IPv6SocketAddress() {}
 ...
 protected:
  struct sockaddr_in6 *_pIP6Addr;
  struct sockaddr_in6 _sockAddrStruct;
};
