...
#ifndef TOSERIALIZER_H_
#define TOSERIALIZER_H_
...
class ToSerializer : public Serializer
{
public:
	ToSerializer();
	virtual ~ToSerializer();
...
private:
	void writeCharBufferSize(unsigned long &strSize);
};

};


#endif /*TOSERIALIZER_H_*/
