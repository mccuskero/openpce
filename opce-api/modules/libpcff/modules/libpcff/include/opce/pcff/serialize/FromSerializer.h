...
#ifndef FROMSERIALIZER_H_
#define FROMSERIALIZER_H_
...
class FromSerializer : public Serializer
{
public:
	FromSerializer();
	virtual ~FromSerializer();
...
private:
	unsigned long readCharBufferSize();

};

};

#endif /*FROMSERIALIZER_H_*/
