...
#ifndef _EchoProxyServerThread_h
#define _EchoProxyServerThread_h
...
class EchoProxyServer;

class EchoProxyServerThread : public pcff::ProxyServerThread
{
public:
   EchoProxyServerThread(EchoProxyServer &proxy);
  ~EchoProxyServerThread();

public:
  virtual void init(int addrFamily, std::string forwardHost, int forwardPort);           // initializes thread
