...
#ifndef TestServerPoolThread_h
#define TestServerPoolThread_h
...
class TestServerPoolThread : public pcff::ServerPoolThread
{
public:
   TestServerPoolThread(pcff::ServerPool &pool);
  virtual ~TestServerPoolThread();
