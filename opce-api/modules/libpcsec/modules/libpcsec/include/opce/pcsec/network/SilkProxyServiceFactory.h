...
#ifndef SilkProxyServiceFactory_h_
#define SilkProxyServiceFactory_h_
...
class SilkProxyServiceFactory : public pcff::ProxyServiceFactory
{
public:
	SilkProxyServiceFactory();
	virtual ~SilkProxyServiceFactory();
...
private:
	...
	pcff::EventIngestor *createSilkFileIngestor(pcff::InformationList &createInfo);
	pcff::EventIngestor *createSilkDatastoreIngestor(pcff::InformationList &createInfo);
};

};

#endif /*SilkProxyServiceFactory_h_*/
